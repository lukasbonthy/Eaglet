...
# --- Deeper feature pruning so TeaVM can eliminate the higher-level code too ---

# Recording controller: constant-false support and no state.
...
# Voice controller: preserve the protocol-facing API but make it stateless and unsupported.
...
# Shared-world LAN controller: keep singleplayer and ordinary websocket multiplayer,
# but remove relay/WebRTC hosting and joining behavior.
